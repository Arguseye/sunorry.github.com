...
* [blog-node-express-mongodb](https://github.com/nswbmw/N-blog/wiki/_pages)

* [nodejs-beginners-guide](http://blog.codeship.io/2014/05/07/nodejs-beginners-guide.html) `未读`
...
* [js编程指南](http://pij.robinqu.me/) `未读`

* [jquery hover mouseenter mouseleave事件只触发一次动画](http://segmentfault.com/q/1010000000511662) `未读`

* [Javascript 设计模式读书笔记(一)——接口](http://blog.segmentfault.com/classicemi/1190000000480609) `未读`

* [sofish-JavaScript 类型浅解](http://sofish.de/2330) `未读`
...
* [林小志-扯一下似乎被遗忘的盒模型](http://blog.segmentfault.com/linxz/1190000000476826) <code style="color:green">已读</code>

* [CSS 类名的单词连字符：下划线还是连接符？](http://blog.jobbole.com/67280/) `未读`

* [EM单位的好处是什么?](http://www.zhihu.com/question/23660843/answer/25297479?utm_source=weibo&utm_medium=weibo_share&utm_content=share_answer&utm_campaign=share_button) <code style="color:green">已读</code>

* [CSS box-sizing 属性为什么没有 margin-box？](http://www.zhihu.com/question/23531841) `未读`

* [深入浏览器理解CSS animations 和 transitions的性能问题](http://sy-tang.github.io/2014/05/14/CSS%20animations%20and%20transitions%20performance-%20looking%20inside%20the%20browser/) `未读`

* [使用 CSS3 Flexible Boxes 布局](http://blog.segmentfault.com/classicemi/1190000000484017) `未读`
...
* [Backbone Tutorials](http://backbonetutorials.com/) `未读`

* [Backbone精髓，观察者模式和事件](http://blog.segmentfault.com/p_chou/1190000000480727) `未读`

* [认识 Backbone（一） : 什么是 Model](http://blog.segmentfault.com/stephenlee/1190000000465965) `未读`

* [SPA,NODE](http://mixu.net/) `未读`
...
* [Web开发最佳实践(Google Web Fundamentals)](https://github.com/flynngao/WebFundamentals) `未读`
...
* [从输入 URL 到页面加载完成的过程中都发生了什么事情？](http://fex.baidu.com/blog/2014/05/what-happen/) `未读`

* [从点击到呈现](http://zrj.me/archives/tag/%E4%BB%8E%E7%82%B9%E5%87%BB%E5%88%B0%E5%91%88%E7%8E%B0) `未读`

* [从输入URL到页面加载完成的过程中都发生了什么事情？](http://segmentfault.com/q/1010000000489803) `未读`
